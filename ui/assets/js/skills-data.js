...
window.skillsData = {
    ...
    quick_slash: {
        ...
        name: 'Quick Slash',
        icon: 'sword',
        img: 'assets/icons/skills/quick_slash.webp',
        mana: 5,
        dmgMult: 1.0,
        type: 'single',
    ...
    guarded_strike: {
        ...
        name: 'Guarded Strike',
        icon: 'shield',
        img: 'assets/icons/skills/guarded_strike.webp',
        mana: 15,
        dmgMult: 1.2,
        type: 'single',
    ...
    parry_stance: {
        ...
        name: 'Parry Stance',
        icon: 'shield',
        img: 'assets/icons/skills/parry_stance.webp',
        mana: 15,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    heavy_slash: {
        ...
        name: 'Heavy Slash',
        icon: 'sword',
        img: 'assets/icons/skills/heavy_slash.webp',
        mana: 20,
        dmgMult: 1.5,
        type: 'single',
    ...
    shield_bash: {
        ...
        name: 'Shield Bash',
        icon: 'shield',
        img: 'assets/icons/skills/shield_bash.webp',
        mana: 25,
        dmgMult: 1.3,
        type: 'single',
    ...
    taunting_shout: {
        ...
        name: 'Taunting Shout',
        icon: 'speaker',
        img: 'assets/icons/skills/taunting_shout.webp',
        mana: 10,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    cleave: {
        ...
        name: 'Cleave',
        icon: 'target',
        img: 'assets/icons/skills/cleave.webp',
        mana: 30,
        dmgMult: 0.8,
        type: 'aoe',
    ...
    defensive_wall: {
        ...
        name: 'Defensive Wall',
        icon: 'shield-check',
        img: 'assets/icons/skills/defensive_wall.webp',
        mana: 30,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    crushing_blow: {
        ...
        name: 'Crushing Blow',
        icon: 'hammer',
        img: 'assets/icons/skills/crushing_blow.webp',
        mana: 25,
        dmgMult: 1.6,
        type: 'single',
    ...
    battle_focus: {
        ...
        name: 'Battle Focus',
        icon: 'zap',
        img: 'assets/icons/skills/battle_focus.webp',
        mana: 40,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    relentless_strike: {
        ...
        icon: 'sword',
        img: 'assets/icons/skills/relentless_strike.webp',
        mana: 35,
        dmgMult: 0.7,
        hits: 2,
        type: 'single',
    ...
    champions_slash: {
        ...
        icon: 'crown',
        img: 'assets/icons/skills/champions_slash.webp',
        mana: 60,
        dmgMult: 2.2,
        type: 'single',
        effects: [
    ...
    quick_shot: {
        ...
        name: 'Quick Shot',
        icon: 'target',
        img: 'assets/icons/skills/quick_shot.webp',
        mana: 5,
        dmgMult: 0.9,
        type: 'single',
    ...
    aimed_shot: {
        ...
        name: 'Aimed Shot',
        icon: 'crosshair',
        img: 'assets/icons/skills/aimed_shot.webp',
        mana: 15,
        dmgMult: 1.3,
        type: 'single',
    ...
    evasive_step: {
        ...
        name: 'Evasive Step',
        icon: 'move-diagonal',
        img: 'assets/icons/skills/evasive_step.webp',
        mana: 15,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    power_shot: {
        ...
        name: 'Power Shot',
        icon: 'zap',
        img: 'assets/icons/skills/power_shot.webp',
        mana: 20,
        dmgMult: 1.5,
        type: 'single',
    ...
    poison_arrow: {
        ...
        name: 'Poison Arrow',
        icon: 'skull',
        img: 'assets/icons/skills/poison_arrow.webp',
        mana: 25,
        dmgMult: 1.2,
        type: 'single',
    ...
    rapid_fire: {
        ...
        name: 'Rapid Fire',
        icon: 'arrow-right',
        img: 'assets/icons/skills/rapid_fire.webp',
        mana: 30,
        dmgMult: 0.6,
        hits: 2,
        type: 'single',
    ...
    multishot: {
        ...
        name: 'Multishot',
        icon: 'target',
        img: 'assets/icons/skills/multishot.webp',
        mana: 40,
        dmgMult: 0.8,
        type: 'aoe',
    ...
    crippling_shot: {
        ...
        name: 'Crippling Shot',
        icon: 'footprints',
        img: 'assets/icons/skills/crippling_shot.webp',
        mana: 30,
        dmgMult: 1.4,
        type: 'single',
        debuff: {
    ...
    shadow_volley: {
        ...
        name: 'Shadow Volley',
        icon: 'cloud',
        img: 'assets/icons/skills/shadow_volley.webp',
        mana: 45,
        dmgMult: 1.0,
        type: 'aoe',
    ...
    hunters_focus: {
        ...
        name: 'Hunter\'s Focus',
        icon: 'eye',
        img: 'assets/icons/skills/hunters_focus.webp',
        mana: 35,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    piercing_arrow: {
        ...
        name: 'Piercing Arrow',
        icon: 'arrow-right',
        img: 'assets/icons/skills/piercing_arrow.webp',
        mana: 40,
        dmgMult: 1.6,
        type: 'pierce',
    ...
    rain_of_arrows: {
        ...
        name: 'Rain of Arrows',
        icon: 'cloud-rain',
        img: 'assets/icons/skills/rain_of_arrows.webp',
        mana: 60,
        dmgMult: 1.4,
        type: 'aoe',
        effects: [
    ...
    summon_wolf: {
        ...
        icon: 'sparkles',
        img: 'assets/icons/skills/summon_wolf.png',
        mana: 50,
        type: 'summon',
    ...
    // SHARED / GENERIC
    // ========================================
    bash: { name: 'Heavy Bash', mana: 20, dmgMult: 1.2, icon: 'shield', img: 'assets/icons/skills/shield_bash.webp', desc: '40% Stun chance.', type: 'single', effect: { id: 'stun', chance: 0.4, duration: 1 } },
    // ========================================
    ...
    toxin: { name: 'Envenom', mana: 25, dmgMult: 1.1, icon: 'skull', img: 'assets/icons/skills/3.webp', desc: '80% Poison chance.', type: 'single', effect: { id: 'poison', chance: 0.8, duration: 4 } },

    // Basic supports used by some enemies / legacy data
    rally: { name: 'Recover', mana: 50, dmgMult: 0, icon: 'flag', img: 'assets/icons/skills/2.webp', desc: 'Heal self.', type: 'self' },
    ...
    frost: { name: 'Frost Bolt', mana: 22, dmgMult: 1.1, icon: 'snowflake', img: 'assets/icons/skills/2.webp', type: 'single', damageType: 'magic', element: 'water', effect: { id: 'freeze', chance: 0.2, duration: 1 }, desc: 'A chilling bolt with a small freeze chance.' },
    ...
    fireball: { name: 'Fireball', mana: 30, dmgMult: 1.55, icon: 'flame', img: 'assets/icons/skills/2.webp', type: 'single', damageType: 'magic', element: 'fire', effect: { id: 'burn', chance: 0.5, duration: 3 }, desc: 'A fire burst with a chance to burn.' },
    ...
    shock: { name: 'Thunder Clap', mana: 35, dmgMult: 1.35, icon: 'zap', img: 'assets/icons/skills/3.webp', type: 'single', damageType: 'magic', element: 'wind', effect: { id: 'paralyze', chance: 0.5, duration: 2 }, desc: 'A shock of lightning with a paralyze chance.' },
    ...
    meteor: {
        ...
        hits: 7,
        icon: 'flame',
        img: 'assets/icons/skills/1.webp',
        type: 'aoe',
        damageType: 'magic',
        element: 'fire',
        ultimate: true,
    ...
    backstab: { name: 'Backstab', mana: 22, dmgMult: 1.45, icon: 'dagger', img: 'assets/icons/skills/3.webp', type: 'single', critBonus: 0.25, defenseIgnore: 0.15, desc: 'A precise strike from the shadows (+crit).' },
    ...
    // ACOLYTE (Lv 1–12)
    // ========================================
    heal: { name: 'Heal', mana: 22, dmgMult: 0, icon: 'heart', img: 'assets/icons/skills/2.webp', type: 'self', healPct: 0.40, desc: 'Restore 40% of your max HP.' },
    ...
    mana_drain: {
        ...
        name: 'Mana Drain',
        icon: 'zap',
        img: 'assets/icons/skills/mana_drain.png',
        mana: 40,
        type: 'single',
        drainPercent: 0.4, // 40% do MP atual
        minDrain: 20, // Mínimo de MP roubado
    ...
    reflect_shield: {
        ...
        name: 'Reflect Shield',
        icon: 'shield',
        img: 'assets/icons/skills/reflect_shield.png',
        mana: 45,
        type: 'self',
        buff: {
            id: 'reflect_shield',
    ...
    revive: {
        ...
        name: 'Revive',
        icon: 'heart',
        img: 'assets/icons/skills/revive.png',
        mana: 70,
        type: 'revive',
    ...
    berserk_mode: {
        id: 'berserk_mode',
        name: 'Berserk Mode',
        img: 'assets/icons/skills/berserk_mode.webp',
        mana: 65,
        type: 'self',
        buff: {
            id: 'berserk_mode',
