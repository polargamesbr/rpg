/**
 * Audio Registry - Mapeamento de Eventos Sonoros para Arquivos de Áudio
 * 
 * Estrutura de fallback:
 * 1. skill[skillId][event] - Som específico da skill
 ...
 * 5. global[event] - Som global padrão
 */

window.audioRegistry = {
    // Sons globais padrão (fallback final)
    global: {
        skill_start: [
        ...
        skill_voice: [] // Opcional, não tem fallback global
    },
    ...
    // Sons específicos por skill (pode ser expandido)
    skill: {
        volcanic_arrowstorm: {
        ...
        // Exemplos - podem ser adicionados mais conforme necessário
        // quick_slash: {
