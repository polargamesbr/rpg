window.combatData = {
    ...
    entities: {
        ...
        bandit_marauder: {
            name: 'Bandit Marauder', type: 'monster', element: 'neutral', img: 'assets/img/bandit_marauder.png',
        ...
        rock_golem_small: {
            name: 'Rock Golem (Small)', type: 'monster', element: 'earth', img: 'assets/img/rock_golem_small.png',
        ...
        skeleton_soldier: {
            name: 'Skeleton Soldier', type: 'monster', element: 'undead', img: 'assets/img/skeleton_soldier.png',
        ...
        orc_scout: {
            name: 'Orc Scout', type: 'monster', element: 'earth', img: 'assets/img/orc_scout.png',
        ...
        harpy: {
            name: 'Harpy', type: 'monster', element: 'wind', img: 'assets/img/harpy.png',
        ...
        troll_warrior: {
            name: 'Troll Warrior', type: 'monster', element: 'earth', img: 'assets/img/troll_warrior.png',
        ...
        captain_grimbeard: {
            name: 'Captain Grimbeard', type: 'monster', element: 'shadow', img: 'assets/img/captain_grimbeard.png',
        ...
        // ========================================
        gelatinous_cube: {
            name: 'Gelatinous Cube', type: 'monster', element: 'poison', img: 'assets/img/gelatinous_cube.png',
        ...
        feral_wolf: {
            name: 'Feral Wolf', type: 'monster', element: 'neutral', img: 'assets/img/feral_wolf.png',
        ...
        // ========================================
        thief_rat: {
            name: 'Thief Rat', type: 'monster', element: 'neutral', img: 'assets/img/placeholder.png',
        ...
        sewer_slime: {
            name: 'Sewer Slime', type: 'monster', element: 'poison', img: 'assets/img/placeholder.png',
        ...
        gang_member: {
            name: 'Gang Member', type: 'monster', element: 'neutral', img: 'assets/img/placeholder.png',
        ...
        cursed_coin: {
            name: 'Cursed Coin', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        ghoul_dunrath: {
            name: 'Ghoul', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        shadow_stalker: {
            name: 'Shadow Stalker', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        zombie_dunrath: {
            name: 'Zombie', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        assassin_ghost: {
            name: 'Assassin Ghost', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        wight_dunrath: {
            name: 'Wight', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        thug_boss: {
            name: 'Thug Boss', type: 'monster', element: 'neutral', img: 'assets/img/placeholder.png',
        ...
        shadowlord_vex: {
            name: 'Shadowlord Vex', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        // ========================================
        corrupted_spirit: {
            name: 'Corrupted Spirit', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        skeleton_warrior_lumenfall: {
            name: 'Skeleton Warrior', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        wandering_soul: {
            name: 'Wandering Soul', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        cursed_grave: {
            name: 'Cursed Grave', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        fallen_acolyte: {
            name: 'Fallen Acolyte', type: 'monster', element: 'holy', img: 'assets/img/placeholder.png',
        ...
        mummy_lumenfall: {
            name: 'Mummy', type: 'monster', element: 'undead', img: 'assets/img/placeholder.png',
        ...
        banshee_lumenfall: {
            name: 'Banshee', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        death_priest: {
            name: 'Death Priest', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        necromancer_valdis: {
            name: 'Necromancer Valdis', type: 'monster', element: 'shadow', img: 'assets/img/placeholder.png',
        ...
        // ========================================
        cave_bat: {
            name: 'Cave Bat', type: 'monster', element: 'neutral', img: 'assets/img/placeholder.png',
        ...
        rock_mole: {
            name: 'Rock Mole', type: 'monster', element: 'earth', img: 'assets/img/placeholder.png',
        ...
        coal_golem: {
            name: 'Coal Golem', type: 'monster', element: 'fire', img: 'assets/img/placeholder.png',
        ...
        kobold_miner: {
            name: 'Kobold Miner', type: 'monster', element: 'earth', img: 'assets/img/placeholder.png',
        ...
        fire_sprite: {
            name: 'Fire Sprite', type: 'monster', element: 'fire', img: 'assets/img/placeholder.png',
        ...
        crystal_golem: {
            name: 'Crystal Golem', type: 'monster', element: 'earth', img: 'assets/img/placeholder.png',
        ...
        earth_elemental: {
            name: 'Earth Elemental', type: 'monster', element: 'earth', img: 'assets/img/placeholder.png',
        ...
        lava_slime: {
            name: 'Lava Slime', type: 'monster', element: 'fire', img: 'assets/img/placeholder.png',
        ...
        forge_guardian: {
            name: 'Forge Guardian', type: 'monster', element: 'fire', img: 'assets/img/placeholder.png',
        ...
        forge_master_krag: {
            name: 'Forge Master Krag', type: 'monster', element: 'fire', img: 'assets/img/placeholder.png',
