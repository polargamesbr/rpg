...
window.effectsData = {
  // ---- STATUS / DEBUFFS ----
  poison: { type: 'debuff', name: 'Poison', lucide: 'skull', png: 'assets/icons/debuff/poison.png', desc: 'Taking damage every turn.' },
  bleed: { type: 'debuff', name: 'Bleed', lucide: 'droplet', png: 'assets/icons/debuff/bleed.png', desc: 'Losing health over time.' },
  burn: { type: 'debuff', name: 'Burn', lucide: 'flame', png: 'assets/icons/debuff/burn.png', desc: 'Taking fire damage.' },
  freeze: { type: 'debuff', name: 'Freeze', lucide: 'snowflake', png: 'assets/icons/debuff/freeze.png', desc: 'Cannot act while frozen.' },
  stun: { type: 'debuff', name: 'Stun', lucide: 'lock', png: 'assets/icons/debuff/stun.png', desc: 'Cannot act.' },
  paralyze: { type: 'debuff', name: 'Paralyze', lucide: 'zap', png: 'assets/icons/debuff/paralyze.png', desc: '50% chance to fail actions.' },
  slow: { type: 'debuff', name: 'Slow', lucide: 'snail', png: 'assets/icons/debuff/slow.png', desc: 'Reduced speed.' },
  disease: { type: 'debuff', name: 'Disease', lucide: 'bug', png: 'assets/icons/debuff/diase.png', desc: 'Reduces stats and causes damage over time.' },
