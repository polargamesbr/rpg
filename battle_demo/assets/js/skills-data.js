...
window.skillsData = {
    ...
    quick_slash: {
        ...
        name: 'Quick Slash',
        icon: 'sword',
        img: 'assets/icons/skills/quick_slash.png',
        mana: 5,
        dmgMult: 1.0,
        type: 'single',
    ...
    guarded_strike: {
        ...
        name: 'Guarded Strike',
        icon: 'shield',
        img: 'assets/icons/skills/guarded_strike.png',
        mana: 15,
        dmgMult: 1.2,
        type: 'single',
    ...
    parry_stance: {
        ...
        name: 'Parry Stance',
        icon: 'shield',
        img: 'assets/icons/skills/parry_stance.png',
        mana: 15,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    heavy_slash: {
        ...
        name: 'Heavy Slash',
        icon: 'sword',
        img: 'assets/icons/skills/heavy_slash.png',
        mana: 20,
        dmgMult: 1.5,
        type: 'single',
    ...
    shield_bash: {
        ...
        name: 'Shield Bash',
        icon: 'shield',
        img: 'assets/icons/skills/shield_bash.png',
        mana: 25,
        dmgMult: 1.3,
        type: 'single',
    ...
    taunting_shout: {
        ...
        name: 'Taunting Shout',
        icon: 'speaker',
        img: 'assets/icons/skills/taunting_shout.png',
        mana: 10,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    cleave: {
        ...
        name: 'Cleave',
        icon: 'target',
        img: 'assets/icons/skills/cleave.png',
        mana: 30,
        dmgMult: 0.8,
        type: 'aoe',
    ...
    defensive_wall: {
        ...
        name: 'Defensive Wall',
        icon: 'shield-check',
        img: 'assets/icons/skills/defensive_wall.png',
        mana: 30,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    crushing_blow: {
        ...
        name: 'Crushing Blow',
        icon: 'hammer',
        img: 'assets/icons/skills/crushing_blow.png',
        mana: 25,
        dmgMult: 1.6,
        type: 'single',
    ...
    battle_focus: {
        ...
        name: 'Battle Focus',
        icon: 'zap',
        img: 'assets/icons/skills/battle_focus.png',
        mana: 40,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    relentless_strike: {
        ...
        icon: 'sword',
        img: 'assets/icons/skills/relentless_strike.png',
        mana: 35,
        dmgMult: 0.7,
        hits: 2,
        type: 'single',
    ...
    champions_slash: {
        ...
        icon: 'crown',
        img: 'assets/icons/skills/champions_slash.png',
        mana: 60,
        dmgMult: 2.2,
        type: 'single',
        effects: [
    ...
    quick_shot: {
        ...
        name: 'Quick Shot',
        icon: 'target',
        img: 'assets/icons/skills/quick_shot.png',
        mana: 5,
        dmgMult: 0.9,
        type: 'single',
    ...
    aimed_shot: {
        ...
        name: 'Aimed Shot',
        icon: 'crosshair',
        img: 'assets/icons/skills/aimed_shot.png',
        mana: 15,
        dmgMult: 1.3,
        type: 'single',
    ...
    evasive_step: {
        ...
        name: 'Evasive Step',
        icon: 'move-diagonal',
        img: 'assets/icons/skills/evasive_step.png',
        mana: 15,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    power_shot: {
        ...
        name: 'Power Shot',
        icon: 'zap',
        img: 'assets/icons/skills/power_shot.png',
        mana: 20,
        dmgMult: 1.5,
        type: 'single',
    ...
    poison_arrow: {
        ...
        name: 'Poison Arrow',
        icon: 'skull',
        img: 'assets/icons/skills/poison_arrow.png',
        mana: 25,
        dmgMult: 1.2,
        type: 'single',
    ...
    rapid_fire: {
        ...
        name: 'Rapid Fire',
        icon: 'arrow-right',
        img: 'assets/icons/skills/rapid_fire.png',
        mana: 30,
        dmgMult: 0.6,
        hits: 2,
        type: 'single',
    ...
    multishot: {
        ...
        name: 'Multishot',
        icon: 'target',
        img: 'assets/icons/skills/multishot.png',
        mana: 40,
        dmgMult: 0.8,
        type: 'aoe',
    ...
    crippling_shot: {
        ...
        name: 'Crippling Shot',
        icon: 'footprints',
        img: 'assets/icons/skills/crippling_shot.png',
        mana: 30,
        dmgMult: 1.4,
        type: 'single',
        debuff: {
    ...
    shadow_volley: {
        ...
        name: 'Shadow Volley',
        icon: 'cloud',
        img: 'assets/icons/skills/shadow_volley.png',
        mana: 45,
        dmgMult: 1.0,
        type: 'aoe',
    ...
    hunters_focus: {
        ...
        name: 'Hunter\'s Focus',
        icon: 'eye',
        img: 'assets/icons/skills/hunters_focus.png',
        mana: 35,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    piercing_arrow: {
        ...
        name: 'Piercing Arrow',
        icon: 'arrow-right',
        img: 'assets/icons/skills/piercing_arrow.png',
        mana: 40,
        dmgMult: 1.6,
        type: 'pierce',
    ...
    rain_of_arrows: {
        ...
        name: 'Rain of Arrows',
        icon: 'cloud-rain',
        img: 'assets/icons/skills/rain_of_arrows.png',
        mana: 60,
        dmgMult: 1.4,
        type: 'aoe',
        effects: [
    ...
    // SHARED / GENERIC
    // ========================================
    bash: { name: 'Heavy Bash', mana: 20, dmgMult: 1.2, icon: 'shield', img: 'assets/icons/skills/shield_bash.png', desc: '40% Stun chance.', type: 'single', effect: { id: 'stun', chance: 0.4, duration: 1 } },
    // ========================================
    ...
    rally: { name: 'Recover', mana: 50, dmgMult: 0, icon: 'flag', img: 'assets/icons/skills/2.png', desc: 'Heal target.', type: 'ally' },
    ...
    frost: { name: 'Frost Bolt', mana: 22, dmgMult: 1.1, icon: 'snowflake', img: 'assets/icons/skills/2.png', type: 'single', damageType: 'magic', element: 'water', effect: { id: 'freeze', chance: 0.2, duration: 1 }, desc: 'A chilling bolt with a small freeze chance.' },
    ...
    fireball: { name: 'Fireball', mana: 30, dmgMult: 1.55, icon: 'flame', img: 'assets/icons/skills/2.png', type: 'single', damageType: 'magic', element: 'fire', effect: { id: 'burn', chance: 0.5, duration: 3 }, desc: 'A fire burst with a chance to burn.' },
    ...
    shock: { name: 'Thunder Clap', mana: 35, dmgMult: 1.35, icon: 'zap', img: 'assets/icons/skills/3.png', type: 'single', damageType: 'magic', element: 'wind', effect: { id: 'paralyze', chance: 0.5, duration: 2 }, desc: 'A shock of lightning with a paralyze chance.' },
    ...
    backstab: { name: 'Backstab', mana: 22, dmgMult: 1.45, icon: 'dagger', img: 'assets/icons/skills/3.png', type: 'single', critBonus: 0.25, defenseIgnore: 0.15, desc: 'A precise strike from the shadows (+crit).' },
    ...
    // ACOLYTE (Lv 1â€“12)
    // ========================================
    heal: { name: 'Heal', mana: 22, dmgMult: 0, icon: 'heart', img: 'assets/icons/skills/2.png', type: 'ally', healPct: 0.40, desc: 'Restore 40% target Max HP.' },
    ...
    berserk_mode: {
        id: 'berserk_mode',
        name: 'Berserk Mode',
        img: 'assets/icons/skills/berserk_mode.png',
        mana: 65,
        type: 'self',
        buff: {
            id: 'berserk_mode',
