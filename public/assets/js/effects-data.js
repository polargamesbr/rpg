...
window.effectsData = {
  // ---- STATUS / DEBUFFS ----
  poison: { type: 'debuff', name: 'Poison', lucide: 'skull', png: '/public/assets/icons/debuff/poison.png', desc: 'Taking damage every turn.' },
  bleed: { type: 'debuff', name: 'Bleed', lucide: 'droplet', png: '/public/assets/icons/debuff/bleed.png', desc: 'Losing health over time.' },
  burn: { type: 'debuff', name: 'Burn', lucide: 'flame', png: '/public/assets/icons/debuff/burn.png', desc: 'Taking fire damage.' },
  freeze: { type: 'debuff', name: 'Freeze', lucide: 'snowflake', png: '/public/assets/icons/debuff/freeze.png', desc: 'Cannot act while frozen.' },
  stun: { type: 'debuff', name: 'Stun', lucide: 'lock', png: '/public/assets/icons/debuff/stun.png', desc: 'Cannot act.' },
  paralyze: { type: 'debuff', name: 'Paralyze', lucide: 'zap', png: '/public/assets/icons/debuff/paralyze.png', desc: '50% chance to fail actions.' },
  slow: { type: 'debuff', name: 'Slow', lucide: 'snail', png: '/public/assets/icons/debuff/slow.png', desc: 'Reduced speed.' },
  disease: { type: 'debuff', name: 'Disease', lucide: 'bug', png: '/public/assets/icons/debuff/diase.png', desc: 'Reduces stats and causes damage over time.' },

  // ---- BUFFS ----
  hunters_focus: { type: 'buff', name: "Hunter's Focus", lucide: 'eye', png: '/public/assets/icons/skills/hunters_focus.png', desc: 'Increases DEX, accuracy, crit and damage.' },
  battle_focus: { type: 'buff', name: 'Battle Focus', lucide: 'zap', png: '/public/assets/icons/skills/battle_focus.png', desc: 'Increases damage and core stats.' },
  defensive_wall: { type: 'buff', name: 'Defensive Wall', lucide: 'shield-check', png: '/public/assets/icons/skills/defensive_wall.png', desc: 'Reduces damage taken.' },
  parry_stance: { type: 'buff', name: 'Parry Stance', lucide: 'shield', png: '/public/assets/icons/skills/parry_stance.png', desc: 'Chance to block attacks.' },
