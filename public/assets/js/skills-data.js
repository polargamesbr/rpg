...
window.skillsData = {
    ...
    quick_slash: {
        ...
        name: 'Quick Slash',
        icon: 'sword',
        img: '/public/assets/icons/skills/quick_slash.webp',
        mana: 5,
        dmgMult: 1.0,
        type: 'single',
        range: 1,
    ...
    guarded_strike: {
        ...
        name: 'Guarded Strike',
        icon: 'shield',
        img: '/public/assets/icons/skills/guarded_strike.webp',
        mana: 15,
        dmgMult: 1.2,
        type: 'single',
    ...
    parry_stance: {
        ...
        name: 'Parry Stance',
        icon: 'shield',
        img: '/public/assets/icons/skills/parry_stance.webp',
        mana: 15,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    heavy_slash: {
        ...
        name: 'Heavy Slash',
        icon: 'sword',
        img: '/public/assets/icons/skills/heavy_slash.webp',
        mana: 20,
        dmgMult: 2.0,
        hits: 2,
        type: 'single',
    ...
    shield_bash: {
        ...
        name: 'Shield Bash',
        icon: 'shield',
        img: '/public/assets/icons/skills/shield_bash.webp',
        mana: 25,
        dmgMult: 1.3,
        type: 'single',
    ...
    taunting_shout: {
        ...
        name: 'Taunting Shout',
        icon: 'speaker',
        img: '/public/assets/icons/skills/taunting_shout.webp',
        mana: 10,
        dmgMult: 0,
        type: 'self',
        buff: {
    ...
    cleave: {
        ...
        name: 'Cleave',
        icon: 'target',
        img: '/public/assets/icons/skills/cleave.webp',
        mana: 30,
        dmgMult: 0.8,
        type: 'aoe',
        range: 1,
    ...
    defensive_wall: {
        ...
        name: 'Defensive Wall',
        icon: 'shield-check',
        img: '/public/assets/icons/skills/defensive_wall.webp',
        mana: 30,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    crushing_blow: {
        ...
        name: 'Crushing Blow',
        icon: 'hammer',
        img: '/public/assets/icons/skills/crushing_blow.webp',
        mana: 25,
        dmgMult: 1.6,
        type: 'single',
    ...
    battle_focus: {
        ...
        name: 'Battle Focus',
        icon: 'zap',
        img: '/public/assets/icons/skills/battle_focus.webp',
        mana: 40,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    relentless_strike: {
        ...
        icon: 'sword',
        img: '/public/assets/icons/skills/relentless_strike.webp',
        mana: 35,
        dmgMult: 0.7,
        hits: 2,
        type: 'single',
    ...
    champions_slash: {
        ...
        icon: 'crown',
        img: '/public/assets/icons/skills/champions_slash.webp',
        mana: 60,
        dmgMult: 3.0,
        hits: 3,
        type: 'single',
    ...
    quick_shot: {
        ...
        name: 'Quick Shot',
        icon: 'target',
        img: '/public/assets/icons/skills/quick_shot.webp',
        mana: 5,
        dmgMult: 0.9,
        type: 'single',
    ...
    aimed_shot: {
        ...
        name: 'Aimed Shot',
        icon: 'crosshair',
        img: '/public/assets/icons/skills/aimed_shot.webp',
        mana: 15,
        dmgMult: 1.3,
        type: 'single',
    ...
    evasive_step: {
        ...
        name: 'Evasive Step',
        icon: 'move-diagonal',
        img: '/public/assets/icons/skills/evasive_step.webp',
        mana: 15,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    power_shot: {
        ...
        name: 'Power Shot',
        icon: 'zap',
        img: '/public/assets/icons/skills/power_shot.webp',
        mana: 20,
        dmgMult: 1.5,
        type: 'single',
    ...
    poison_arrow: {
        ...
        name: 'Poison Arrow',
        icon: 'skull',
        img: '/public/assets/icons/skills/poison_arrow.webp',
        mana: 25,
        dmgMult: 1.2,
        type: 'single',
    ...
    rapid_fire: {
        ...
        name: 'Rapid Fire',
        icon: 'arrow-right',
        img: '/public/assets/icons/skills/rapid_fire.webp',
        mana: 30,
        dmgMult: 0.6,
        hits: 2,
        type: 'single',
    ...
    multishot: {
        ...
        name: 'Multishot',
        icon: 'target',
        img: '/public/assets/icons/skills/multishot.webp',
        mana: 40,
        dmgMult: 0.8,
        type: 'aoe',
    ...
    crippling_shot: {
        ...
        name: 'Crippling Shot',
        icon: 'footprints',
        img: '/public/assets/icons/skills/crippling_shot.webp',
        mana: 30,
        dmgMult: 1.4,
        type: 'single',
        debuff: {
    ...
    shadow_volley: {
        ...
        name: 'Shadow Volley',
        icon: 'cloud',
        img: '/public/assets/icons/skills/shadow_volley.webp',
        mana: 45,
        dmgMult: 1.0,
        type: 'aoe',
    ...
    hunters_focus: {
        ...
        name: 'Hunter\'s Focus',
        icon: 'eye',
        img: '/public/assets/icons/skills/hunters_focus.webp',
        mana: 35,
        dmgMult: 0,
        type: 'ally',
        buff: {
    ...
    piercing_arrow: {
        ...
        name: 'Piercing Arrow',
        icon: 'arrow-right',
        img: '/public/assets/icons/skills/piercing_arrow.webp',
        mana: 40,
        dmgMult: 1.6,
        type: 'pierce',
    ...
    rain_of_arrows: {
        ...
        name: 'Rain of Arrows',
        icon: 'cloud-rain',
        img: '/public/assets/icons/skills/rain_of_arrows.webp',
        mana: 60,
        dmgMult: 1.4,
        type: 'aoe',
        effects: [
    ...
    // SHARED / GENERIC
    // ========================================
    bash: { name: 'Heavy Bash', mana: 20, dmgMult: 1.2, icon: 'shield', img: '/public/assets/icons/skills/shield_bash.webp', desc: '40% Stun chance.', type: 'single', effect: { id: 'stun', chance: 0.4, duration: 1 } },
    // ========================================
    ...
    toxin: { name: 'Envenom', mana: 25, dmgMult: 1.1, icon: 'skull', img: '/public/assets/icons/skills/3.webp', desc: '80% Poison chance.', type: 'single', effect: { id: 'poison', chance: 0.8, duration: 4 } },

    // Basic supports used by some enemies / legacy data
    rally: { name: 'Recover', mana: 50, dmgMult: 0, icon: 'flag', img: '/public/assets/icons/skills/2.webp', desc: 'Heal target.', type: 'ally' },
    ...
    frost: { name: 'Frost Bolt', mana: 22, dmgMult: 1.1, icon: 'snowflake', img: '/public/assets/icons/skills/2.webp', type: 'single', damageType: 'magic', element: 'water', effect: { id: 'freeze', chance: 0.2, duration: 1 }, desc: 'A chilling bolt with a small freeze chance.' },
    ...
    fireball: { name: 'Fireball', mana: 30, dmgMult: 1.55, icon: 'flame', img: '/public/assets/icons/skills/2.webp', type: 'single', damageType: 'magic', element: 'fire', effect: { id: 'burn', chance: 0.5, duration: 3 }, desc: 'A fire burst with a chance to burn.' },
    ...
    shock: { name: 'Thunder Clap', mana: 35, dmgMult: 1.35, icon: 'zap', img: '/public/assets/icons/skills/3.webp', type: 'single', damageType: 'magic', element: 'wind', effect: { id: 'paralyze', chance: 0.5, duration: 2 }, desc: 'A shock of lightning with a paralyze chance.' },
    ...
    meteor: {
        ...
        hits: 7,
        icon: 'flame',
        img: '/public/assets/icons/skills/1.webp',
        type: 'aoe',
        damageType: 'magic',
        element: 'fire',
        ultimate: true,
    ...
    backstab: { name: 'Backstab', mana: 22, dmgMult: 1.45, icon: 'dagger', img: '/public/assets/icons/skills/3.webp', type: 'single', critBonus: 0.25, defenseIgnore: 0.15, desc: 'A precise strike from the shadows (+crit).' },
    ...
    // ACOLYTE (Lv 1â€“12)
    // ========================================
    heal: { name: 'Heal', mana: 22, dmgMult: 0, icon: 'heart', img: '/public/assets/icons/skills/2.webp', type: 'ally', healPct: 0.40, desc: 'Restore 40% target Max HP.' },
    ...
    berserk_mode: {
        id: 'berserk_mode',
        name: 'Berserk Mode',
        img: '/public/assets/icons/skills/berserk_mode.webp',
        mana: 65,
        type: 'self',
        buff: {
            id: 'berserk_mode',
